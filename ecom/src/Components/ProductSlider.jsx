                        ...
                        <div className="col-lg-5 wow fadeIn" data-wow-delay="0.1s" style={{ position: "relative" }}>
                            {
                                maincategory?.map(item => {
                                    return <div key={item.id} className="">
                                        <h1 className="text-white mb-5 text-dark bg-light fs-4 position-absolute">Our Latest <span
                                            className="text-uppercase text-dark bg-light px-2">{item.name} Products</span></h1>
                                                    ...
                                                    return <SwiperSlide key={p.id}>
                                                        <div className="wow fadeIn" data-wow-delay="0.2s">
                                                            <div className="project-item position-relative overflow-hidden">
                                                                <img className="img-fluid w-100" style={{ height: 250 }} src={`${import.meta.env.VITE_APP_IMAGE_SERVER}/${p.pic[0]}`} alt="" />
