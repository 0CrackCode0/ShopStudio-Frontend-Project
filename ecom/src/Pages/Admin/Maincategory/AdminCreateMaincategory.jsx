...
export default function AdminCreateMaincategory() {
    ...
    function getInputData(e) {
        ...
        let value = name === "pic" ? "/maincategory/" + e.target.files[0].name : e.target.value     // <-- use this line for the dummy backend
        ...
        if (error)
            ...
            if (item) {
                ...
                setErrorMessage(old => {
                    return {
                        ...old,
                        'name': 'Maincategory with this Name filed is already exist'
                    }
                })
            }
            else {
