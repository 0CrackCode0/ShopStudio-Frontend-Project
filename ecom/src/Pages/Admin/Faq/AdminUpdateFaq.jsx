        ...
        if (error)
            ...
            if (item) {
                ...
                setErrorMessage(old => {
                    return {
                        ...old,
                        'name': 'Faq with this Name filed is already exist'
                    }
                })
            }
            else {
            ...
            <div className="container-fluid my-3">
                <div className="row">
                    ...
                    <div className="col-md-9">
                        <h5 className='border p-2 text-center'>Update Faq<Link to="/admin/faq"><i className="fa fa-arrow-left float-end"></i></Link></h5>
                        ...
                        <form onSubmit={postData}>
                            <div className="row">
                                ...
                                <div className="col-12 mb-3">
                                    ...
                                    <input type="text" name="question" value={data.question} onChange={getInputData} placeholder='Question Field' className={`${show && errorMessage.question ? 'border-danger' : ''} form-control`} />
                                    {show && errorMessage.question ? <p className='text-danger'>{errorMessage.question}</p> : null}
                                </div>

                                <div className="col-12 mb-3">
                                    <label>Answer*</label>
                                    <textarea name="answer" value={data.answer} onChange={getInputData} placeholder="Answer Field" rows={3} className={`${show && errorMessage.answer ? 'border-danger' : ''} form-control`} />
