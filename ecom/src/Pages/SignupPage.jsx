...
export default function SignupPage() {
    ...
    async function postData(e) {
        ...
        if (error)
            ...
            setShow(true)
            setErrorMessage({ ...errorMessage, 'password': 'Password and Confirm Passwword Does Not Matched' })
        }
        else {
    ...
    return (
        <>
            ...
            <div className="container my-5">
                <h5 className='text-center p-2 bg-primary text-light'>Create Account</h5>
                <form onSubmit={postData}>
                    <div className="row">
                        ...
                        <div className="col-md-6 mb-3">
                            <label>Phone*</label>
                            <input type="number" name="phone" onChange={getInputData} placeholder='Phone Number' className={`${show && errorMessage.phone ? 'border-danger' : 'border-dark'} form-control`} />
                ...
                <div>
                    <Link to="/login">Do you have an account? <strong>Login</strong></Link>
                </div>
            </div>
        </>
