                ...
                <div className="container mt-6">
                    <div className="row g-0">
                        <div className="col-lg-5 wow fadeIn" data-wow-delay="0.1s" style={{ position: "relative" }}>
                            <span className="text-uppercase text-primary bg-light px-2 position-absolute">Other Latest Related Products</span>
                            <img src={`/img/image11.png`} className='w-100' style={{ height: 300 }} />
                        </div>
